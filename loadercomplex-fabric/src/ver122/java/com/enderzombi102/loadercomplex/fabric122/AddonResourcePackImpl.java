...
public class AddonResourcePackImpl extends CustomResourcePack implements AddonResourcePack {
	...
	protected InputStream openResource( String filename ) throws IOException {
		LOGGER.debug( "Minecraft is opening \"{}\"", filename );
	...
	protected boolean hasResource( String filename ) {
		...
		LOGGER.debug( "Minecraft is searching for \"{}\" (found: {})", filename, hasFile );
		return hasFile;
	}
