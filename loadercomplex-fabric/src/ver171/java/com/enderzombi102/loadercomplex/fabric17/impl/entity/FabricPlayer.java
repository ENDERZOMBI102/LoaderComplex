...
public class FabricPlayer extends FabricLivingEntity implements PlayerEntity {
	private final net.minecraft.entity.player.PlayerEntity wrappedEntity;

	public FabricPlayer(net.minecraft.entity.player.PlayerEntity backingEntity) {
		super(backingEntity);
	...
	public Position getBedLocation() {
		return BlockUtils.toPosition( this.wrappedEntity.getSleepingPosition().orElseThrow( () -> new NoSuchElementException("No value present") ) );
	}
