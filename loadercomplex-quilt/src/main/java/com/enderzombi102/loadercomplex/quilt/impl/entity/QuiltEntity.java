...
public class QuiltEntity implements Entity {
	...
	public QuiltEntity(net.minecraft.entity.Entity backingEntity) {
	...
	public LivingEntity asLivingEntity() {
		return new QuiltLivingEntity( (net.minecraft.entity.LivingEntity) this.backingEntity );
	}
	...
	public ItemEntity asItem() {
		return new QuiltItemEntity( (net.minecraft.entity.ItemEntity) this.backingEntity);
	}
