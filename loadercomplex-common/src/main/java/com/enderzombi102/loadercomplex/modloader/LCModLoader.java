...
public class LCModLoader {
	...
	public ArrayList<ContentMod> getMods() {
		final ArrayList<ContentMod> contentMods = new ArrayList<>();
		for ( Mod mod : this.mods ) contentMods.add( mod.implementation );
		return contentMods;
	}
