...
public abstract class Item {
	...
	public ItemStack finishUsing(ItemStack stack, Object user) {
		return stack;
	}
	public boolean postHit(ItemStack stack, Object target, Object attacker) {
		return false;
	}

	public boolean postMine(ItemStack stack, Object miner) {
		return false;
	}

	public boolean isEffectiveOn(Object state) {
		return false;
	}
